...
(self.webpackChunkKleedkamerscherm = self.webpackChunkKleedkamerscherm || []).push([[429], {
  435: (ie, Ee, de) => {
    de(583);
  },
  583: () => {
      ...
      let d = (() => {
        class M {
          ...
          runTask(t, r, k) {
            ...
            const C = t.state != m;
            C && t._transitionTo(m, j), t.runCount++;
            const $ = re;
            re = t, U = {
              parent: U,
              zone: this
            ...
            try {
              ...
              t.state !== x && t.state !== h && (t.type == Q || t.data && t.data.isPeriodic ? C && t._transitionTo(j, m) : (t.runCount = 0, this._updateTaskCount(t, -1), C && t._transitionTo(x, m, x))), U = U.parent, re = $;
            }
          }
          scheduleTask(t) {
    ...
    const Be = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope,
      ...
      We = function (e) {
        ...
        const i = this || e.target || Y,
          o = i[n];
        let c;
        return je && i === Te && "error" === e.type ? (c = o && o.call(this, e.message, e.filename, e.lineno, e.colno, e.error), !0 === c && e.preventDefault()) : (c = o && o.apply(this, arguments), null != c && !c && e.preventDefault()), c;
      };
    function qe(e, n, i) {
      let o = ie(e, n);
      if (!o && i && ie(i, n) && (o = {
      ...
      P || (P = Re[d] = A("ON_PROPERTY" + d)), o.set = function (v) {
        let p = this;
        !p && e === Y && (p = Y), p && ("function" == typeof p[P] && p.removeEventListener(d, We), y && y.call(p, null), p[P] = v, "function" == typeof v && p.addEventListener(d, We, !1));
      }, o.get = function () {
        let v = this;
    ...
    Zone.__load_patch("ZoneAwarePromise", (e, n, i) => {
      ...
      function z(l, u, s) {
        ...
        if (l[q] === j) {
          ...
          if (u !== G && s instanceof t && s.hasOwnProperty(q) && s.hasOwnProperty(R) && s[q] !== j) re(s), z(l, s[q], s[R]);else if (u !== G && "function" == typeof g) try {
            ...
            l[q] = u;
            const b = l[R];
            if (l[R] = s, l[_] === _ && u === m && (l[q] = l[x], l[R] = l[K]), u === G && s instanceof Error) {
      ...
      function C(l) {
        ...
        const f = u.then;
        u[p] = f, l.prototype.then = function (g, b) {
          return new t((D, O) => {
            f.call(this, D, O);
          }).then(g, b);
        }, l[k] = !0;
    ...
    function dt(e, n, i, o) {
      const c = o && o.add || Oe,
        ...
        Z = function (R, _, K) {
          ...
          const x = R.callback;
          let X;
          "object" == typeof x && x.handleEvent && (R.callback = m => x.handleEvent(m), R.originalDelegate = x);
          try {
            R.invoke(R, _, [K]);
          } catch (m) {
            X = m;
      ...
      function N(R, _, K) {
        ...
        if (X) {
          ...
          if (1 === X.length) {
            ...
            const m = X.slice();
            for (let G = 0; G < m.length && (!_ || !0 !== _[Ke]); G++) {
              const h = Z(m[G], x, _);
              h && j.push(h);
            }
          }
      ...
      function J(R, _) {
        ...
        let m = R;
        for (; m && !m.hasOwnProperty(c);) m = de(m);
        if (!m && R[c] && (m = R), !m || m[P]) return !1;
        const G = _ && _.eventNameToString,
          ...
          oe = m[A(d)] = m[d];
        let z;
        _ && _.prepend && (z = m[A(_.prepend)] = m[_.prepend]);
          ...
          u = function (s, f, g, b, T = !1, D = !1) {
            return function () {
              ...
              let De,
                ...
                ot = !1;
              if (pe) {
                if (ot = !0, X) for (let _e = 0; _e < pe.length; _e++) if (C(pe[_e], V)) return;
              } else pe = O[rt] = [];
              ...
              return h.target = null, be && (be.taskData = null), nt && (se.once = !0), !ye && "boolean" == typeof he.options || (he.options = se), he.target = O, he.capture = xe, he.eventName = S, F && (he.originalDelegate = V), D ? pe.unshift(he) : pe.push(he), T ? O : void 0;
            };
          };
        return m[c] = u(I, v, t, r, j), z && (m[p] = u(z, L, function (s) {
          ...
          if (j) return this;
        }, ue(m[c], I), ue(m[a], w), oe && ue(m[d], oe), Q && ue(m[y], Q), !0;
      }
      let q = [];
        ...
        return P && P.prototype && c.forEach(function (p) {
          ...
          try {
            if (Z.hasOwnProperty(p)) {
              ...
              N && N.value ? (N.value = e.wrapWithCurrentZone(N.value, L), e._redefineProperty(P.prototype, p, N)) : Z[p] && (Z[p] = e.wrapWithCurrentZone(Z[p], L));
    ...
    Zone.__load_patch("legacy", e => {
      ...
      const n = "set",
        i = "clear";
      me(e, n, i, "Timeout"), me(e, n, i, "Interval"), me(e, n, i, "Immediate");
      ...
      !function P(v) {
        ...
        function q(h) {
          ...
          return N.call(w, H, oe), w[i] || (w[i] = h), m.apply(w, I.args), w[a] = !0, h;
        }
        function R() {}
        function _(h) {
          const I = h.data;
        ...
        const K = le(L, "open", () => function (h, I) {
          ...
          m = le(L, "send", () => function (h, I) {
            if (!0 === n.current[j] || h[o]) return m.apply(h, I);
            {
              const w = {
                  target: h,
                  url: h[y],
